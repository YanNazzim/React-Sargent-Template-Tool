  ...
  SSL1: [
    {
      ...
      MechOptions: "",
      CylOptions: "std, 10, 10-21, 10-63, ...",
      finishes: "03, US03, 04, US04, 10, US10, ...",
      image: Images.SSL1,
      ...
      installation: [
        {
          device: "SSL1",
          image: Images.SSL1,
          title: "SSL1 Spring Latch Installation Instructions",
          link: "https://storage.googleapis.com/aa-americas/dam/AADSS1175905",
          text: "View Installation Instructions Doc# A7963",
        },
        {
          device: "SSL1",
          image: Images.SSL1,
          title: "SSL1 Spring Latch Catalog (Aux Locks)",
          link: "https://www.sargentlock.com/en/view-pdf?id=AADSS1004857&page=3",
          text: "View Auxiliary Locks Catalog Doc# 90129",
        },
      ],
    },
  ],
  ...
  8200: [
    {
      ...
      installation: [
        {
          device: "8200",
          image: Images.Aux8200,
          title: "8200 Deadbolt Catalog (Aux Locks)",
          link: "https://www.sargentlock.com/en/view-pdf?id=AADSS1004857&page=4",
          text: "View Auxiliary Locks Catalog Doc# 90129",
        },
        {
          device: "8200",
          image: Images.Aux8200,
          title: "8200 Deadbolt Parts Manual",
          link: "https://storage.googleapis.com/aa-americas/dam/AADSS1014667",
          text: "View Parts Manual Doc# A4741",
        },
      ],
    },
  ],
      ...
      installation: [
        {
          device: "9200",
          image: Images.Aux8200,
          title: "9200 Deadbolt Catalog",
          link: "https://www.sargentlock.com/en/view-pdf?id=AADSS1004645&page=14",
          text: "View Auxiliary Locks Catalog Doc# 90129",
        },
        {
          device: "9200",
          image: Images.Aux8200,
          title: "9200 Deadbolt Parts Manual",
          link: "https://storage.googleapis.com/aa-americas/dam/AADSS1014671",
          text: "View Parts Manual Doc# A4743",
        },
      ],
    },
  ],
      ...
      installation: [
        {
          ...
          text1:
          "View 130 Thumbturn and 184 Emergency Release Installation Instructions Doc# A5675",
        },
        {
          device: "4870",
          image: Images.Aux4870,
          title: "4870 Deadbolt Catalog",
          link: "https://www.sargentlock.com/en/view-pdf?id=AADSS1004857&page=5",
          text: "View Auxiliary Locks Catalog Doc# 90129",
        },
      ],
    },
  ...
  480: [
    {
      ...
      installation: [
        ...
        },
        {
          ...
          image: Images.Aux4870,
          title: "4870 Deadbolt Catalog",
          link: "https://www.sargentlock.com/en/view-pdf?id=AADSS1004857&page=6",
          text: "View Auxiliary Locks Catalog Doc# 90129",
        },
      ],
    },
  ...
  460: [
    {
      ...
      installation: [
        ...
        },
        {
          device: "460",
          image: Images.Aux460,
          title: "460 Deadbolt Catalog",
          link: "https://www.sargentlock.com/en/view-pdf?id=AADSS1004857&page=7",
          text: "View Auxiliary Locks Catalog Doc# 90129",
        },
      ],
    },

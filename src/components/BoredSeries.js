...
function BoredSeries() {
  ...
  const seriesList = [
    ...
    { id: "7 Line", name: "7 Line", image: Images.Bored7Line, series: "7 Line" },
    {
      id: "6500 Series",
      name: "6500 Series",
    ...
    { id: "6 Line", name: "6 Line", image: Images.Bored6Line, series: "6 Line" },
    { id: "DL Series", name: "DL Series", image: Images.BoredDL, series: "DL Series" },
  ];

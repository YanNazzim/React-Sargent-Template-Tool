        ...
        <>
            <div className="stile-page">
                ...
                <button className="btn" onClick={() => handleButtonClick('8200')}>
                    <img className="btn-image" src={Images.Mortise8200} alt="Mortise Lock"/>
                    8200
                </button>
                {/* Button for 9200 series */}
                <button className="btn" onClick={() => handleButtonClick('9200')}>
                    <img className="btn-image" src={Images.Mortise9200} alt="Mortise Lock"/>
                    9200
                </button>
                {/* Button for M9200 series */}
                <button className="btn" onClick={() => handleButtonClick('M9200')}>
                    <img className="btn-image" src={Images.MortiseM9200} alt="Mortise Lock"/>
                    M-9200
                </button>
